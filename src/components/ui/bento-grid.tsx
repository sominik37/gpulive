...
const BentoCard = ({
  ...
  >
    ...
    <div className="relative z-10 p-4 pt-12 flex flex-col h-full justify-between">
      <div className="pointer-events-none flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        <Icon className="h-12 w-12 origin-left transform-gpu text-neutral-400 transition-all duration-300 ease-in-out group-hover:scale-75 group-hover:text-primary" />
      ...
      >
        <Link
          to={href}
          className="pointer-events-auto p-0 flex items-center gap-2 text-primary text-sm font-medium hover:underline"
        >
          {cta}
